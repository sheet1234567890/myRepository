              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6>   TOTAL CONTECT:-><%=request.getAttribute("con") %></h6>
                 </div>
               </div>
              </div>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <table id="example" class="display hover" style="width:100%;height:220px;" border="1px">
                      <thead border="1">
                          <tr>
                      ...
                      <tbody id="showData">
                          ...
                          { %>
                          <a class="fav" onclick="return confirm('are you sure unfav contect')" href="./PhoneBookController?Action=CONTECTFAVORAITE&cid=<%=l.getcId() %>&conisfav=<%=l.getcIsfav() %>" ><img class="clogo" src="./pages/login/unfav.png"></a>
                          <%} %>
