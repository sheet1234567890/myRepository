            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <form action="./PhoneBookController">
                    ...
                    <table id="example" class="display hover" style="width:100%;height:220px;">
                      ...
                      <tbody id="showData">
                          ...
                          <td><%=l.getcMobile() %></td>
                          <td><%=l.getcAddress() %></td>
                          <td ><input id ="containercheak" class="selectedcontect" type="checkbox" name="contect" value="<%=l.getcId()%>"></td>
                          
                        <%--   <td><%if(l.getcIsfav())
                          { %>
                          <a class="fav" onclick="return confirm('are you sure you fav contect')" href="./PhoneBookController?Action=CONTECTFAVORAITE&cid=<%=l.getcId() %>&conisfav=<%=l.getcIsfav() %>" ><img class="clogo" src="./pages/login/fav.png"></a>
                      
                          <%}
                          else
                          { %>
                          <a class="fav" onclick="return confirm('are you sure fav contect')" href="./PhoneBookController?Action=CONTECTFAVORAITE&cid=<%=l.getcId() %>&conisfav=<%=l.getcIsfav() %>" ><img class="clogo" src="./pages/login/unfav.png"></a>
                          <%} %>
                          
                          </td> --%>
                          <%-- <td><a class="edit" onclick="return confirm('are you sure update details')" href="./PhoneBookController?Action=TOEDITCONTECT&cid=<%=l.getcId()%>">EDIT </a>
                          <a class="delete" onclick="return confirm('are you sure delete details')" href="./PhoneBookController?Action=DELETECONTECT&cid=<%=l.getcId() %>" >DELETE</a>
                  ...
                  <input type="hidden" name="Action" value="ADDCONTECTTOGROUP">
