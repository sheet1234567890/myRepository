...
.navbar .navbar-menu-wrapper .search-field .input-group input {
  ...
  <body>
   <%User user = (User)request.getAttribute("user"); %>
    ...
    <%Contect contect=(Contect)request.getAttribute("contect"); %>
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item" href="./PhoneBookController?Action=GETUSER" style="color: #2F2D3B;">
                  ...
                  <a class="dropdown-item"  href="#myModal2" data-toggle="modal" style="color: #2F2D3B;" >
                    ...
                    <a class="dropdown-item"  href="./PhoneBookController?Action=USERDELETE" data-toggle="modal" style="color: #2F2D3B;" >
                    ...
                    <form action="./PhoneBookController">
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Enter name" name="name" value='<%=contect.getcName() %>'>
                          </div>
                          <div class="col">
                            <label for="name">Email ID</label>
                            <input type="text" class="form-control" id="name" placeholder="Enter email" name="email" value='<%=contect.getcEmail() %>'>
                           <br>
                      ...
                      <div class="row">
                        <div class="col">
                          ...
                          <input type="tel" class="form-control" id="phone" placeholder="Enter no" name="mobaile" value='<%=contect.getcMobile() %>'>
                        </div>
                         <div class="col">
                          <label for="phone">Address</label>
                          <input type="tel" class="form-control" id="phone" placeholder="Enter no" name="address" value='<%=contect.getcAddress() %>'>
                        </div>
                        <div class="col">
                          <!-- <form>
                            <fieldset>
 ...
 -->
                    ...
                    <input type="hidden" name="Action" value="EDITCONTECT">
                     <input type="hidden" name="conId" value=<%=contect.getcId() %>>
