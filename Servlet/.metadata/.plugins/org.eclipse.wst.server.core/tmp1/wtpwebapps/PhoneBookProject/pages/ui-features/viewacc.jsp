          ...
          <div class="search-field d-none d-md-block">
            <form class="d-flex align-items-center h-100" action="#">
              <div class="input-group">
                ...
                <input type="text" class=" bg-transparent border-0" placeholder="Search projects" id="search">
              </div>
            </form>
          </div>
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                ...
                <a class="dropdown-item" href="../login/login.html" style="color: #2F2D3B;">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="createapp.html">Create Application</a></li>
                  <li class="nav-item"> <a class="nav-link" href="viewapp.html">View Applications</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="createcase.html">Create Case</a></li>
                  <li class="nav-item"> <a class="nav-link" href="plan.html">Plan Selection</a></li>
                  <li class="nav-item"> <a class="nav-link" href="income.html">Income Details</a></li>
                  <li class="nav-item"> <a class="nav-link" href="education.html">Education Details</a></li>
                  <li class="nav-item"> <a class="nav-link" href="kids.html">Kids Details</a></li>
                  <li class="nav-item"> <a class="nav-link" href="summary.html">Summary Screen</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic2">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="Determine.html">Determine Eligibility</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#general-pages" aria-expanded="false" aria-controls="general-pages">
                <span class="menu-title"><i class="fa fa-bars" style="font-size:20px"></i>&nbsp;Correspondence</span>
                <i class="menu-arrow"></i>
              
              </a>
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="viewnotic.html">Correspondence</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pendingnotic.html">Pending Notices</a></li>
                  <li class="nav-item"> <a class="nav-link" href="historynotic.html">History Notices</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="viewacc.html">View Account</a></li>
                  <li class="nav-item"> <a class="nav-link" href="createplan.html">Create Plan</a></li>
                  <li class="nav-item"> <a class="nav-link" href="viewplan.html">View Plan</a></li>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div style="overflow-x:auto;">
                      <table id="example" class="display hover" style="width:100%;height: 200px;" >
                        <thead>
                            <tr>
                                <th>S.NO</th>
                                <th>Name</th>
        ...
        <div class="modal-header flex-column">
          <form>
            ...
            <div class="form-group row">
              ...
              font-size: 1.5rem;">Edit Accounts</h3>
              <label for="inputnumber" class="col-sm-3 col-form-label"  autofocus>S.NO:</label>
              <div class="col-sm-9">
              ...
              <div class="col-sm-9">
                <input type="email" class="form-control" id="inputemail" placeholder="jondoe@gmail.com">
              </div>
              <label for="inputnumber" class="col-sm-3 col-form-label">Number</label>
              <div class="col-sm-9">
                <input type="number" class="form-control" id="inputnumber" placeholder="1234567890">
              </div>
              <label for="inputtext" class="col-sm-3 col-form-label">Gender</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="inputtext" placeholder="Male">
              </div>
              <label for="inputtext" class="col-sm-3 col-form-label">SSN</label>
              <div class="col-sm-9">
    ...
    function showData(){
          ...
          if ($.fn.DataTable.isDataTable('#example')){
            ...
            Object.keys(data).forEach(function(key) {
                ...
                html += '<td>'+data[key].Delete+'<button href="#myModal"  data-toggle="modal" class="btn btn-danger btn-sm trigger-btn" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></button> </td>'; 
