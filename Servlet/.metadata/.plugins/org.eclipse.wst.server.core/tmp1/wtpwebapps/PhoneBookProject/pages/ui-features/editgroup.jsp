                  ...
                  <div class="card-body">
                    <form action="./PhoneBookController">
                      <div class="form-group">
                        <label for="number">Create Group</label>
                        <input type="text" class="form-control" placeholder="Enter group name" name="gname" value="<%=group.getgName() %>" id="number" style="background-color:rgb(244, 244, 245);">
                        <input type="hidden" name="gid" value="<%=group.getgId() %>">
