            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black"><%=admin.getuName() %></p>
                </div>
              </a>
                        ...
                        <div class="auth-form-light text-left p-5">
                          ...
                          <form class="pt-3" action="./PhoneBookController">
                              <div class="row mt-2">
                                  ...
                                  <input type="text"  name="Name"  class="form-control"  value='<%=user.getuName()%>'  id="exampleInputName" >
                                  <span id="nameError" class="error"></span>
                                  </div>

                                  <div class="col-md-6"><label class="labels">Address</label>
                                  <input type="text"   name="Address"  class="form-control"  value='<%=user.getuAddress()%>'  ></div>
                              </div>
                              <div class="row mt-2">
                                <div class="col-md-6">
                                <label class="labels">Mobile Number</label>
                                <input type="tel" name="Mobile"  id="exampleInputMobaile" class="form-control"  value='<%=user.getuMobile() %>'   required>
                                <span id="mobileError" class="error"></span>
                                </div>
                                <div class="col-md-6"><label class="labels">Gmail</label>
                                <input type="gmail" name="Email" class="form-control" value='<%=user.getuEmail() %>'   required>
                               <%--    <input type="text" name="Role" class="form-control" value='<%=user.getuRole()%>'   required> 
                                     --%>
                                    <div >
                                    
                                    <input type="radio" id ="add" name="Role" value="admin" <%if(user.getuRole().equals("admin")){ %>checked="checked" <%} %>><label for="html">admin</label><br>
                                     <input type="radio" id ="add" name="Role" value="user" <%if(user.getuRole().equals("user")) {%>checked="checked" <%} %> ><label for="html">user</label><br>
                                    </div>
                           ...
                           <div>
                            ...
                            <!-- <form>
                            <fieldset>
                              <legend style="font-size:1rem;">Role</legend>
                              <div style="margin-top:2rem;">
                             
                                <input type="radio" id="contactChoice3" name="contact" value= "male"/>
                                <label for="contactChoice3">User</label>
                                &nbsp; &nbsp;
                            ...
                            <input type="hidden"  value="UPDATEUSERBYADMIN" name="Action">
                              <div class="mt-5 text-center"><button type ="submit" class="btn btn-primary profile-button" onclick="return validation()">Save Profile</button>
                              <%--  < <%if(request.getAttribute("msg")!=null){ %>
