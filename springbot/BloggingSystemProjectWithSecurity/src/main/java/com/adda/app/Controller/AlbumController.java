...
public class AlbumController {
	...
	/**Create Album*/
	@PostMapping("/create")
	public ResponseEntity<Album>createAlbum(@RequestBody Album album,Principal p)
	{
		
		return new ResponseEntity<Album>(aservice.CreateAlbum(album,p),HttpStatus.CREATED);
	}
	/**Get Album By Id*/
	@GetMapping("/{id}")
	...
	public ResponseEntity<List<Photos>>getAllPhotoInAlbum(@PathVariable("id")Integer id)
	{
